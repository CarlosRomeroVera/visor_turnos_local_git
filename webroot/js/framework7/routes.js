var routes = [
  ...
  //Gobernador
  {
    path: '/principal-gobernador/',
    url: './pages/gobernador/principal.html',
  },
  {
    path: '/gestionar-recursos-gobernador/',
    url: './pages/gobernador/gestionar_recursos_federales.html',
  },
  {
    path: '/detalles-gestionar-recursos-gobernador/',
    url: './pages/gobernador/detalles_gestionar_recursos_federales.html',
  },
  {
    path: '/logistica-audiencias-gobernador/',
    url: './pages/gobernador/logistica_para_audiencias.html',
  },
  {
    path: '/detalles-logistica-audiencias-gobernador/',
    url: './pages/gobernador/detalles_logistica_para_audiencias.html',
  },
  //Dependencia
  {
    path: '/principal-dependencia/',
    url: './pages/dependencia/principal.html',
  },
  {
    path: '/comentarios-dependencia/',
    url: './pages/dependencia/comentarios.html',
  },
  {
    path: '/editar-comentario-dependencia/',
    url: './pages/dependencia/editar_comentario.html',
  },
  {
    path: '/nuevo-comentario-dependencia/',
    url: './pages/dependencia/nuevo_comentario.html',
  },
  {
    path: '/influenza-dependencia/',
    url: './pages/dependencia/influenza.html',
  },
  {
    path: '/editar-influenza-dependencia/',
    url: './pages/dependencia/editar_influenza.html',
  },
  {
    path: '/nuevo-influenza-dependencia/',
    url: './pages/dependencia/nuevo_influenza.html',
  },
  {
    path: '/fumigacion-dependencia/',
    url: './pages/dependencia/fumigacion.html',
  },
  {
    path: '/editar-fumigacion-dependencia/',
    url: './pages/dependencia/editar_fumigacion.html',
  },
  {
    path: '/nuevo-fumigacion-dependencia/',
    url: './pages/dependencia/nuevo_fumigacion.html',
  },
  //*********************************************************
  {
    path: '/accordion/',
