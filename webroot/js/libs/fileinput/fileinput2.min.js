        ...
        i = {
                ...
                _initZoom: function() {
                    var t, a = this,
                        ...
                        n = "#" + i.MODAL_ID;
                    a.showPreview && (a.$modal = e(n), a.$modal && a.$modal.length || (t = e(document.createElement("div")).html(r).insertAfter(a.$container), a.$modal = e("#" + i.MODAL_ID).insertBefore(t), t.remove()), i.initModal(a.$modal), a.$modal.html(a._getModalContent()), e.each(i.MODAL_EVENTS, function(e) {
                        a._listenModalEvent(e)
                    }))
                },
                ...
                _readFiles: function(t) {
                    ...
                    r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function(e, i) {
                        ...
                        var E, x, T, S, F, P, I, k, A, $, z = g + e,
                            ...
                            Z = "";
                        if (h > 0)
                            for (S = 0; h > S; S++) k = v[S], A = r.msgFileTypes[k] || k, Z += 0 === S ? A : ", " + A;
                ...
                _resetFileStack: function() {
                    ...
                    i._getThumbs().each(function() {
                        var n = e(this),
                            ...
                            l = i.filestack[o]; - 1 !== o && (void 0 !== l ? (a[t] = l, r[t] = i._getFileName(l), n.attr({
